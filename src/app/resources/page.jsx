...
import { Users, TrendingUp, Landmark, Handshake, Megaphone, Building2, Presentation, Network, Share2 } from 'lucide-react';
      ...
      <section className="section pt-5">
        <div className="container">
          <div className="text-center fade-up">
            <h1 className="section-title">Resource Mobilization</h1>
            <div className="divider"></div>
            <p className="section-subtitle">Through these strategic mechanisms, AMANI secures the financial, technical, logistical, legal, social, and human resources needed to support local transformation initiatives.</p>
          </div>

          <div className="resources-grid">
            {resources.map((res, index) => (
              <div key={index} className="card r-card fade-up" style={{ transitionDelay: res.delay, padding: '3rem 2rem', textAlign: 'center' }}>
